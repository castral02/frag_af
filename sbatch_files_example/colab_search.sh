#!/bin/bash
#SBATCH --job-name=Pik3r1_colab       # Give your job a name
...
#SBATCH --output=output/Pik3r1_colab.log    # Unique output log for each job
#SBATCH --error=error/Pik3r1_colab.log      # Unique error log for each job
...
INPUT_DIR="/data/CBLCCBR/af_new/Pik3r1"   # Set input directory dynamically
OUTPUT_DIR="/data/CBLCCBR/af_new/Pik3r1"      # Set output directory dynamically
