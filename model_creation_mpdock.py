...
# Configure logging
logging.basicConfig(
    filename='/Users/castroverdeac/Desktop/codes_for_AF/actual_frag_af/model_variations/variation_3/RF/log/model_mpdockq.log',
    level=logging.INFO,
...
def main(filepath, thresholds, rf_iterations=10):
    ...
    cluster_features = ['Charged', 'contact_pairs', 'hb', 'pi_score']
...
if __name__ == "__main__":
    ...
    filename = '/Users/castroverdeac/Desktop/codes_for_AF/actual_frag_af/model_variations/variation_3/RF/models/model_mpdockq.pkl'
